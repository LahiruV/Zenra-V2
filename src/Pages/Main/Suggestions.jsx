...
export default function Suggestions() {
  ...
  useEffect(() => {
    const fetchSuggestions = async () => {
      try {
        ...
        const response = await axios.get(`https://backendnizz.onrender.com/friend/suggestion/${loguser}`, config);
  ...
  const handleSendRequest = async (id) => {
    ...
    try {
      ...
      const response = await axios.post('https://backendnizz.onrender.com/friend/addFriend', data, config);
