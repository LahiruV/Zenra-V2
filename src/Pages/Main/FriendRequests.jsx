...
export default function FriendRequests() {
  ...
  useEffect(() => {
    const fetchRequests = async () => {
      try {
        ...
        const response = await axios.get(`https://backendnizz.onrender.com/friend/allReq/${loguser}`, config);
  ...
  const handleRequest = async (id, status) => {
    try {
      ...
      const response = await axios.put(`https://backendnizz.onrender.com/friend/updateReq/${id}?status=${status}`, {}, config);
