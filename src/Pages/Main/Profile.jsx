...
function Profile() {
    ...
    const fetchUserData = async () => {
        try {
            ...
            const response = await axios.get('https://backendnizz.onrender.com/auth/me', config);
    ...
    const handleDeleteProfile = async () => {
        try {
            ...
            const res = await axios.delete("https://backendnizz.onrender.com/auth/delete", config);
    ...
    const handleSaveChanges = async () => {
        ...
        try {
            ...
            const res = await axios.put(
                "https://backendnizz.onrender.com/auth/update",
                data,
                {
                    headers: {
                        'Authorization': `Bearer ${token}`,
